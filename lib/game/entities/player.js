    ...
    .defines(function () {
        ...
        EntityPlayer = ig.Entity.extend({
            ...
            update: function () {
                ...
                if (ig.input.state('right') && ig.game.currentTurn === 1) {
                    this.moveIntention = moveType.RIGHT;
                   // ig.game.currentTurn = ig.game.turnScheduler.next();
                } else if (ig.input.state('left') && ig.game.currentTurn === 1) {
                    this.moveIntention = moveType.LEFT;
                 //   ig.game.currentTurn = ig.game.turnScheduler.next();
                } else if (ig.input.state('up') && ig.game.currentTurn === 1) {
                    this.moveIntention = moveType.UP;
                  //  ig.game.currentTurn = ig.game.turnScheduler.next();
                } else if (ig.input.state('down') && ig.game.currentTurn === 1) {
